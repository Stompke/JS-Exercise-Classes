...
// const shawn = new Person('shawn',26);
...
class Student extends Lambdasian {
  ...
  graduate(){
    if(this.grade < 70){
      return `I'm sorry ${this.name} your grade is below 70% and can not graduate yet. 😔`;
    } else {
      return `Congradulatons ${this.name}!!!! 🤩YOU GRADUATED!!!🥳`;
    }
